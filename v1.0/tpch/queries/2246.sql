...
MonthlySales AS (
    SELECT toYear(o.o_orderdate) AS order_year,
...
FULL OUTER JOIN MonthlySales ms ON ms.order_year = toYear(r.o_orderdate) 
                                   AND ms.order_month = toMonth(r.o_orderdate)
