WITH PostTagCounts AS (
    SELECT 
        ...
        arrayStringConcat(groupArray(assumeNotNull(T.TagName)), ', ') AS AllTags
    FROM Posts P
...
PostAnalytics AS (
    SELECT 
        ...
        arrayStringConcat(groupArray(assumeNotNull(CONCAT('VoterId: ', V.UserId, ' VoteType: ', VT.Name))), '; ') AS VoteDetails
    FROM Posts P
