...
MovieStatistics AS (
    SELECT t.id AS movie_id, 
           ...
           AVG(CASE WHEN t.production_year IS NOT NULL THEN toYear(toDateTime64('2024-10-01 12:34:56', 6)) - t.production_year ELSE NULL END) AS avg_years_since_release
    FROM aka_title t
...
AND f.avg_years_since_release > (SELECT AVG(years_since_release) 
                                  FROM (SELECT toYear(toDateTime64('2024-10-01 12:34:56', 6)) - ms.production_year AS years_since_release
