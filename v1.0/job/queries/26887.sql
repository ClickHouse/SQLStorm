...
SELECT
    ...
    arrayStringConcat(arrayDistinct(groupArray(assumeNotNull(ami.movie_title))), '; ') AS movie_titles,
    arrayStringConcat(arrayDistinct(groupArray(assumeNotNull(ami.keywords))), '; ') AS all_keywords,
