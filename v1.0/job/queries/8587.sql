...
SELECT 
    ...
    (SELECT arrayStringConcat(groupArray(assumeNotNull(kw.keyword)), ', ') FROM movie_keyword mk JOIN keyword kw ON mk.keyword_id = kw.id WHERE mk.movie_id = tm.movie_id) AS keywords
FROM 
    TopMovies tm
ORDER BY 
