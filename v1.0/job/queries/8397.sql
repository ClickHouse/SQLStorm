...
WITH MovieDetails AS (
    SELECT t.id AS movie_id, t.title, t.production_year, c.name AS company_name, arrayStringConcat(arrayDistinct(groupArray(assumeNotNull(k.keyword))), ', ') AS keywords
    FROM aka_title t
